    ...
    ru: [
        {
            ...
            description: "Уверенное выступление на Центральном стадионе: Верия ФК обыграла Кайрат со счетом 3-0, сократив отставание от лидера до двух очков за восемь туров до конца чемпионата.\n\nВерия ФК показала, почему сейчас они являются самой сильной командой в Премьер-лиге Казахстана. Давление было неустанным с самого начала матча. Капитан команды А. Сейткали контролировал центр поля, отдав голевую передачу на 28-й минуте.",
            date: "18 Мар, 2026",
            image: "/images/AllPlayers.jpg"
        },
        {
            ...
            description: "Верия ФК рада объявить о подписании К. Нурлана из ФК Тобол. 24-летний вингер подписал трехлетний контракт.\n\nНурлан, известный своей скоростью и техникой, усилит атакующий потенциал клуба в борьбе за чемпионство. 'Для меня большая честь присоединиться к Верии ФК', — сказал Нурлан.",
            date: "15 Мар, 2026",
            image: "/images/Handsake.jpg"
        },
        {
            ...
            description: "Будущее Верии ФК выглядит многообещающим: наша юношеская команда U17 завоевала титул чемпионов региона, победив в финале со счетом 2-0.\n\nДиректор академии отметил: 'Ребята проделали огромную работу. Это только начало нашего пути по воспитанию талантов для основной команды'.",
            date: "12 Мар, 2026",
            image: "/images/kneelingimage.jpg"
        },
        {
            ...
            description: "Верия ФК подтверждает, что планы по расширению Южной трибуны Центрального стадиона одобрены. Проект добавит 3000 мест, доведя общую вместимость до 25 000.\n\nСтроительство начнется в межсезонье. 'Наша база болельщиков быстро растет, и мы должны обеспечить места для всех', — заявил стратегический менеджер.",
            date: "8 Мар, 2026",
            image: "/images/LOGO-photoaidcom-cropped.jpg"
        }
    ]
