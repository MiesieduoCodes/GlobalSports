          ...
          {navLinks.map((link) => {
            ...
            return (
              <Link
                ...
                className={`font-bebas text-3xl tracking-[4px] uppercase transition-all ${isActive ? 'text-vgold scale-110' : 'text-vwhite/60 hover:text-vwhite'}`}
              >
                {link.name}
              </Link>
            );
